...
class enpt_Cambridge {
    ...
    async displayName() {
        ...
        if (locale.indexOf('CN') != -1) return '剑桥英语葡萄牙语词典';
        if (locale.indexOf('TW') != -1) return '剑桥英语葡萄牙语词典';
        return 'Cambridge EN->PT Dictionary';
    }
    ...
    async findCambridge(word) {
        ...
        let base = 'https://dictionary.cambridge.org/search/english-portuguese/direct/?q=';
